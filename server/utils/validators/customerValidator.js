...
exports.validatePostArray = [
  ...
  body("password").notEmpty().isStrongPassword().withMessage("First name must be alphabetic"),
  body("street").optional().notEmpty().isAlpha().withMessage("Street must be alphabetic"),
